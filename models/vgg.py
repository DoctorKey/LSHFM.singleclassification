...
class VGG(nn.Module):
    ...
    def __init__(self, cfg, batch_norm=False, num_classes=1000, student_dim=0, force_2FC=False):
        ...
        if force_2FC or (student_dim != raw_feat_dim and student_dim != 0):
            ...
            self.feat_fc = None
            self.classifier = nn.Linear(raw_feat_dim, num_classes)
